 ...
 * человек записан в телефонной книге («Пётр Новак»); если контакта в книге нет —
 * номер в собственном формате приложения («+7 900 123-45-67»). Поэтому запись избранного
 ...
 * иначе «*4567» не совпало бы с «+7 900 123-45-67» из-за дефисов и пробелов.
 */
object NameMatch {
