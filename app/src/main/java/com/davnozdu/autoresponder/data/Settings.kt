...
class Settings(context: Context) {
    ...
    companion object {
        ...
        const val DEF_PROMPT_SMS =
            ...
            "Если спрашивают про часы работы / когда открыто / когда можно подойти / работаете ли завтра — сообщи рабочее время и дай ссылку на запись. " +
            "Если спрашивают про ремонт — скажи, что возможность ремонта зависит от поломки, и попроси прислать данные о проблеме и устройстве на email. " +
            "В остальных случаях поблагодари и скажи, что ответим как можно скорее " +
            "(новому контакту: «спасибо за сообщение, ответим вам как можно быстрее»; " +
            "повторному: «спасибо, ответим как можно быстрее»)."
