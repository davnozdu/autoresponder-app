...
object Greeting {
    ...
    private const val BEEP_GAP_MS = 1200  // пауза между бипами (была 400, затем 800 — пользователь попросил ещё больше)
    private const val BEEP_MS = 1300      // сам сигнал — долгий, ни с чем не спутать
    private const val BEEP_HZ = 1000.0
    private const val BEEP_AMP = 0.35     // была 0.6 — пользователь попросил потише, «противно орёт»
